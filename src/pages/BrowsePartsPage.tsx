...
const BrowsePartsPage: React.FC<BrowsePartsPageProps> = ({ embedded = false }) => {
  ...
  return (
    <div id={embedded ? "browse-parts-section" : undefined} className={embedded ? "" : "min-h-screen bg-[#f5f5f5]"}>
      {/* Hero Section */}
      <section className={`relative w-full ${embedded ? 'pt-8 pb-8' : 'pt-24 pb-16'} px-4 sm:px-6 lg:px-8 ${embedded ? '' : 'bg-white'}`}>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-slate-900">
                Shop <span className="text-slate-900">Gallery</span>
              </h1>
            </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white text-slate-900 px-12 py-3 rounded-xl border border-slate-300 focus:border-slate-500 focus:outline-none transition-colors placeholder-slate-400"
              />
            </div>
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-4">
          <div className="max-w-6xl mx-auto">
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              <p className="flex items-center gap-2 text-slate-900 font-bold text-sm uppercase tracking-widest mb-4">
                <ShoppingCart size={16} className="text-slate-900" /> My
                Reservations
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          {loading ? (
            <div className="text-center py-12">
              <div className="animate-spin w-12 h-12 border-4 border-slate-300 border-t-slate-900 rounded-full mx-auto"></div>
              <p className="text-slate-500 mt-4">Loading items...</p>
            </div>
            ...
            >
              {filteredParts.map((part) => (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-slate-300 transition-all shadow-sm hover:shadow-md cursor-pointer"
                  ...
                  <div className="h-48 bg-slate-100 flex items-center justify-center relative overflow-hidden">
                    {part.image || part.image_url ? (
                      ...
                      <>
                        ...
                        <Zap className="w-16 h-16 text-slate-900 relative z-10" />
                      </>
                    )}
        ...
        {selectedPart && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl border border-slate-200 w-full max-w-[750px] max-h-[90vh] overflow-hidden shadow-xl flex flex-col"
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-50 flex-shrink-0">
                <div className="flex items-center gap-4">
                  <button
                    ...
                    className="p-2 rounded-lg bg-white border border-slate-300 hover:bg-slate-100 text-slate-500 hover:text-slate-900 transition"
                  >
                    <ArrowLeft size={20} />
                  </button>
                  <div>
                    <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">Item Details</p>
                    <h2 className="text-xl font-bold text-slate-900 truncate max-w-[350px]">
                      {selectedPart.name}
                    </h2>
                  </div>
                </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="p-2 rounded-lg bg-slate-100 border border-slate-300 hover:bg-slate-200 text-slate-900 transition"
                              >
                                <Minus size={16} />
                              </button>
                              <span className="text-slate-900 font-bold w-8 text-center">
                                {reserveQty}
                              </span>
                              <button
                                onClick={() =>
                                ...
                                className="p-2 rounded-lg bg-slate-100 border border-slate-300 hover:bg-slate-200 text-slate-900 transition disabled:opacity-40"
                              >
                                <Plus size={16} />
                              </button>
                            </div>
