  ...
  return (
    <div className="min-h-screen bg-moto-dark flex items-center justify-center p-4 text-slate-100">
      ...
      <motion.button
        ...
        className="fixed top-6 left-6 flex items-center gap-2 px-4 py-2 bg-moto-accent hover:bg-moto-accent-dark border border-moto-accent rounded-lg text-slate-950 shadow-sm transition-all z-30"
      ...
      {onHome && (
        <motion.button
          ...
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          className="fixed bottom-6 right-6 flex items-center gap-2 px-4 py-2 bg-moto-accent hover:bg-moto-accent-dark text-slate-950 rounded-xl shadow-sm transition-all z-30"
          whileHover={{ scale: 1.05, x: 4 }}
        >
